// ECE_501_Test.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
private:
	...
	bool mciExecute(string cmd)
	{
		...
		std::wstring test = converter.from_bytes(cmd);
		
		if (mciSendString(test.c_str(), NULL, 0, NULL))
		{
...
int main()
{
   ...
   // PlaySound(TEXT("StarWars60.wav"), GetModuleHandle(NULL), SND_FILENAME);
